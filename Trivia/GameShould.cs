...
namespace Trivia
{
    ...
    class GameShould
    {
        ...
        public void Increment_the_current_player_place_to_the_roll_when_user_roll(int roll)
        {
            ...
            aGame.add("Chet");
            aGame.Roll(roll);
            Check.That(aGame.CurrentPlayer.Place).Equals(roll);
        }
        ...
        public void Go_back_to_when_0_When_roll_12()
        {
            ...
            aGame.add("Chet");
            aGame.Roll(12);
            Check.That(aGame.CurrentPlayer.Place).Equals(0);
        }
        ...
        public void Increase_purse_When_anwser_correctly()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Check.That(aGame.CurrentPlayer.Purse).IsEqualTo(++purse);
            }
        }
        ...
        public void Go_to_penality_box_the_same_purse_When_anwser_is_wrong()
        {
            ...
            aGame.Roll(1);
            aGame.WrongAnswer();
            Check.That(aGame.CurrentPlayer.InPenaltyBox).IsEqualTo(true);
        }
        ...
        public void Remain_the_same_purse_When_anwser_correctly()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                aGame.Roll(1);
                aGame.WrongAnswer();
                Check.That(aGame.CurrentPlayer.Purse).IsEqualTo(0);
            }
        }
        ...
        public void Win_When_answer_6_question_correctly()
        {
            ...
            aGame.add("Chet");
            aGame.Roll(1);
            Check.That(aGame.WasCorrectlyAnswered()).IsTrue();
            aGame.Roll(1);
            Check.That(aGame.WasCorrectlyAnswered()).IsTrue();
            aGame.Roll(1);
            Check.That(aGame.WasCorrectlyAnswered()).IsTrue();
            ...
            Check.That(aGame.WasCorrectlyAnswered()).IsTrue();
            aGame.Roll(1);
            Check.That(aGame.WasCorrectlyAnswered()).IsFalse();
        }
    }
}
